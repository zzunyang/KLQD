...
# 데이터셋 및 모델 로드
dataset = load_dataset("legal_Qeustion_anwsering_dataset")
examples = dataset["train"]
model_name = "model_name"

# Tokenizer 및 모델 설정 로드
...
# 모델 예측 함수
def get_prediction_with_prompt(question):
...
for i, example in enumerate(examples):
    ...
    prediction = get_prediction_with_prompt(question)
    end_time = time.time()
